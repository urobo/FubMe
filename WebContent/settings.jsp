...
<div class="canvas">
	...
	<div class="settingsblock" style="height: 200px">
		...
		%>
			<p>
				<label class="blocktitle">Change profile picture :</label><br /> <input
					type="file" name="newprofilepicture" /><br /> <input type="submit"
	...
	<div class="settingsblock" style="height: 230px">
		...
		<div class="settingsublock">
			<p>
				<label class="blocktitle">Change Password :</label> <br />
				<label>old password</label> <input type="password"
					name="oldpassword" /> <label>new password</label> <input
					type="password" name="newpassword" /> <label>confirm new
					password</label> <input type="password" name="retypepassword" />
			</p>
		...
		<div class="settingsublock" style="margin-left: 20px">
			<p>
				...
				<label>old email</label> <input type="text" name="oldemail" /> <label>new
					email</label> <input type="text" name="newemail" /> <label>confirm
					new email</label> <input type="text" name="retypemail" />
			</p>
	...
	<div class="settingsblock" style="height: 265px">
		...
		<div class="settingsublock">
			...
			<p>
				<label class="blocktitle">Futher Information : </label><br /> <br />
				<label>firstname</label> <input type="text" name="firstname" /> <label>lastname</label>
				<input type="text" name="lastname" /> <label>birthdate
					(YYYY/MM/DD)</label> <input type="text" name="birthdate" maxlength="10" />
