...
<div class="searchresults">
	<div class="rounded" id="peoplelist">People</div>
			...
			<%
				if (request.getAttribute("people") instanceof List<?>) {
					...
					for (int i = 0; i < people.size(); i++) {
						...
						String uImgTmp = UserMapper.getPathToImg(people.get(i).getId()); 
						out.print("<li><div class=\"people\"><img class=\"postimage\" src=\""
								+ request.getScheme()
								+ "://"
								...
								+ "/uploads/"
								+ imgTmp
								+ "\" height=\"48px\" width=\"48px\" alt=\"profile picture\"/><div class=\"author\">"
