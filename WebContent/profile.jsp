...
<jsp:include page="/header.jsp" />
 <div class="rightcolumn">
                ...
                <p><b><% out.print(((User)request.getAttribute("info")).getId()); %></b></p>
                <p><i><% out.print(((User)request.getAttribute("info")).getBio()); %></i></p>
                </div>
              	...
              	<% 
              		if (request.getAttribute("followers") instanceof List<?>){
              			...
              			for (int i = 0; i < followers.size(); i++){
              				out.print("<li><div class=\"author\"> <a href=\""+request.getScheme() +"://"+  request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/Profile?user="+ followers.get(i).getId() +"\">"+followers.get(i).getId()+"</a></div></li>");
              			}
              		}
              	%>
            	 </ul>
                ...
                <% 
              		if (request.getAttribute("following") instanceof List<?>){
              			...
              			for (int i = 0; i < following.size(); i++){
              				out.print("<li><div class=\"author\"> <a href=\""+request.getScheme() +"://"+  request.getServerName() + ":" + request.getServerPort() + request.getContextPath() + "/Profile?user="+ following.get(i).getId() +"\">"+following.get(i).getId()+"</a></div></li>");
              			}
              		}
              	%>
            	 </ul>
